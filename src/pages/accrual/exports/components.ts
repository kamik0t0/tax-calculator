...
export { default as SalaryTable } from "../components/SalaryTable/SalaryTable";
...
export { default as CivilContractCheck } from "../components/SalaryTable/CivilContractCheck";
export { default as SelectEmployeeCell } from "../components/SelectEmployee/SelectEmployeeCell";

export { default as SalaryTableSummary } from "../components/SalaryTable/SalaryTableSummary";
export { default as SalaryTableActions } from "../components/SalaryTable/SalaryTableActions";
export { default as SalaryTableData } from "../components/SalaryTable/SalaryTableData";
