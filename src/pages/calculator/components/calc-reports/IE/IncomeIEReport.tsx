...
const IncomeIEReport: React.FC = () => {
    ...
    return (
        <Dialog open={isIncomeIEDialog} fullWidth maxWidth="md">
                    ...
                    <Table size="small" aria-label="a dense table" stickyHeader>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell width={250} align="right">
                                    {toRU.format(calcData.taxIncomeIE.total)}
                                </TableCell>
                            </TableRow>
                        </TableHead>
                    </Table>
            ...
            <DialogActions>
                <Button onClick={toggleIncomeIEDialog}>Закрыть</Button>
            </DialogActions>
        </Dialog>
    );
};

export default IncomeIEReport;
