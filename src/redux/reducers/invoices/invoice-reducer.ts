...
const createGenericSlice = <Reducers extends SliceCaseReducers<IInvoices>>({
    ...
    return createSlice({
        ...
        initialState,
        reducers: {
            addRow: SharedReducers.addRowReducer(initialState),
            deleteRow: SharedReducers.deleteRowReducer(initialState),
            setCheckBox: SharedReducers.setCheckBoxReducer(initialState),
